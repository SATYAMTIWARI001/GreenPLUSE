...
const defaultDB = {
  ...
  leaderboard: [
    { id: "leader-1", name: "Pulse Master (Admin)", ecoRank: "Sustainability Master", carbonScore: 4.1, points: 4850, type: "user" },
    { id: "leader-2", name: "Elena Rostova", ecoRank: "Earth Champion", carbonScore: 4.8, points: 4200, type: "user" },
    { id: "leader-3", name: "John Sterling", ecoRank: "Green Warrior", carbonScore: 5.5, points: 3900, type: "user" },
